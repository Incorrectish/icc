...
//             ast::Prog::Prog(function_declaration) => self.gen_function(function_declaration),
//         }
//     }
//
...
//                     assembly.add_instructions(self.gen_block_item(statement, symbol_table));
//                 }
...
//     }
//
//     fn gen_block_item(&mut self, block_item: ast::BlockItem, symbol_table: SymbolTable) -> Asm {
//         match block_item {
//             ast::BlockItem::Statement(statement) => self.gen_statement(statement),
//             ast::BlockItem::Declaration(declaration) => self.gen_declaration(declaration, symbol_table)
//         }
//     }
//
//     fn gen_declaration(&mut self, declaration: ast::Declaration, symbol_table: SymbolTable) -> Asm {
//         match declaration {
...
//                     decleration_assembly.add_instructions(self.gen_declaration(child_declaration, symbol_table));
//                 }
...
//                 asm.add_instructions(self.gen_statement(*if_children));
//                 // }
...
//                     asm.add_instructions(self.gen_statement(else_children));
//                     // }
...
//     }
//
//     fn gen_block(&mut self, block: Vec<ast::BlockItem>) -> Asm {
//         let mut asm = Asm::default();
//         for block_item in block {
//             asm.add_instructions(self.gen_block_item(block_item));
//         }
//         asm
//     }
//
...
//                 } else {
//                     fail!("Variable \"{name}\" referenced but not declared");
//                 }
//             }
...
//     }
//
//     fn operation(&self, operator: ast::UnaryOperator) -> Asm {
...
//                     .symbol_table
//                     .get(&name)
//                     .expect(&format!("Variable {name} accessed but not declared"));
